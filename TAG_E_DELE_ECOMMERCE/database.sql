...
('Light Blue Distressed Ripped Jeans', 'Jeans', 'TED-JN-001', 1499, 2099, 16, 'jeans/901031801_g6.webp', 'Bleached ice-blue denim jeans with artisanal knee rips and raw fraying details.', 1, 1, '30,32,34,36,38'),
('Vintage Wash Relaxed Straight Jeans', 'Jeans', 'TED-JN-002', 1399, 1899, 20, 'jeans/images (11).jfif', 'Authentic 90s vintage wash straight-leg blue denim jeans with classic 5-pocket styling.', 1, 1, '30,32,34,36,38'),
('Classic Relaxed Fit Baggy Blue Jeans', 'Jeans', 'TED-JN-003', 1349, 1799, 22, 'jeans/images (12).jfif', 'Medium indigo skater baggy denim with easy roomy thigh and straight leg opening.', 1, 0, '30,32,34,36,38'),
('Heavy Distressed Grunge Denim Jeans', 'Jeans', 'TED-JN-004', 1599, 2299, 14, 'jeans/images (13).jfif', 'Statement grunge destroyed blue jeans with layered fraying and distressing on thighs and knees.', 1, 1, '30,32,34,36,38'),
('Classic Slim Fit Blue Denim Jeans', 'Jeans', 'TED-JN-005', 1299, 1799, 25, 'jeans/images (14).jfif', 'Timeless clean blue denim with flexible comfort stretch and tailored slim leg contour.', 1, 0, '30,32,34,36,38'),
('Light Blue Denim Jogger Jeans', 'Jeans', 'TED-JN-006', 1399, 1949, 18, 'jeans/images (15).jfif', 'Elasticated drawstring waist light blue denim joggers with gathered cuffs and slash pockets.', 1, 1, '30,32,34,36,38'),
('Camo Patch Distressed Tapered Jeans', 'Jeans', 'TED-JN-007', 1449, 1999, 19, 'jeans/images (16).jfif', 'Dark wash distressed tapered jeans with reinforced camouflage backing patches behind knee tears.', 1, 0, '30,32,34,36,38'),
('Washed Dark Grey Relaxed Jeans', 'Jeans', 'TED-JN-008', 1399, 1899, 21, 'jeans/jeanlswhsk-dgrey.webp', 'Smoky charcoal grey enzyme-washed wide-leg denim jeans with clean modern finish.', 1, 1, '30,32,34,36,38'),
('Brown Leather Aviator Bomber Jacket', 'Jackets', 'TED-JK-001', 2699, 3799, 10, 'jackets/images (30).jfif', 'Genuine flight styling with plush shearling faux-fur collar, aviation badges, and zip sleeve pocket.', 1, 1, 'S,M,L,XL,XXL'),
('Tan Suede Bomber Jacket', 'Jackets', 'TED-JK-002', 2499, 3499, 12, 'jackets/images (31).jfif', 'Supple caramel tan suede bomber jacket with ribbed collar, hem, cuffs, and front zip closure.', 1, 1, 'S,M,L,XL,XXL'),
('Distressed Brown Leather Field Jacket', 'Jackets', 'TED-JK-003', 2899, 3999, 8, 'jackets/images (32).jfif', 'Vintage burnished brown leather coat with notched lapels, button front, and flap hip pockets.', 1, 1, 'S,M,L,XL,XXL'),
('Burnished Brown Leather Zip Jacket', 'Jackets', 'TED-JK-004', 2599, 3599, 11, 'jackets/images (33).jfif', 'Sleek front-zip burnished leather jacket with structured shirt collar and dual chest pockets.', 1, 0, 'S,M,L,XL,XXL'),
('Camouflage Hooded Utility Parka', 'Jackets', 'TED-JK-005', 2399, 3299, 14, 'jackets/images (34).jfif', 'High-spec hooded camo utility jacket with technical weatherproofing and multi-compartment storage.', 1, 1, 'S,M,L,XL,XXL'),
('Caramel Lightweight Bomber Jacket', 'Jackets', 'TED-JK-006', 1999, 2799, 16, 'jackets/images (35).jfif', 'Clean minimalist caramel brown bomber jacket with smooth matte zip and ribbed trims.', 1, 0, 'S,M,L,XL,XXL'),
('Olive Green Harrington Jacket', 'Jackets', 'TED-JK-007', 2199, 2999, 15, 'jackets/images (36).jfif', 'Classic British Harrington silhouette with funnel collar, zip closure, and elasticated hem in army olive.', 1, 0, 'S,M,L,XL,XXL'),
('Cream Suede Shearling Collar Jacket', 'Jackets', 'TED-JK-008', 2799, 3899, 9, 'jackets/images (37).jfif', 'Warm ivory cream faux-suede jacket with cozy shearling fleece collar and neck buckle strap.', 1, 1, 'S,M,L,XL,XXL'),
('Stonewash Blue Denim Trucker Jacket', 'Jackets', 'TED-JK-009', 1899, 2599, 18, 'jackets/images (38).jfif', 'Heritage medium blue denim trucker jacket with dual chest flap pockets and shank buttons.', 1, 0, 'S,M,L,XL,XXL'),
('Washed Grey Leather Moto Jacket', 'Jackets', 'TED-JK-010', 2499, 3499, 12, 'jackets/images (39).jfif', 'Distressed acid-wash grey leather jacket with biker mandarin collar and dual chest flap pockets.', 1, 1, 'S,M,L,XL,XXL'),
('Speed Racing Biker Leather Jacket', 'Jackets', 'TED-JK-011', 2999, 4299, 7, 'jackets/images (40).jfif', 'Colorblocked black and white leather motorcycle jacket with racing badges and snap collar.', 1, 1, 'S,M,L,XL,XXL'),
('Scuba Suede Oversized Contrast Jacket', 'Jackets', 'TED-JK-012', 2299, 3199, 13, 'jackets/images (41).jfif', 'Modern drop-shoulder cream and olive contrast scuba suede jacket with asymmetric biker zipper.', 1, 1, 'S,M,L,XL,XXL');
